...
import com.example.foododer.adapter.MoreImageAdapter;
import com.example.foododer.constant.Constant;
import com.example.foododer.databinding.LayoutBottomSheetCartBinding;
...
import com.example.foododer.model.repository.FoodDetailModel;
import com.example.foododer.utils.GlideUtils;
import com.example.foododer.viewmodel.DialogCartViewModel;
...
public class FoodDetailViewModel {
    ...
    private FoodDetailModel foodDetailModel; // Thêm biến repository
    public Food mFood;
    ...
    public FoodDetailViewModel(Activity mActivity, Food mFood) {
        ...
        this.mFood = mFood;
        this.foodDetailModel = new FoodDetailModel(mActivity); // Khởi tạo repository
        initData();
    }
    ...
    public boolean isFoodInCart(int foodId) {
        List<Food> list = foodDetailModel.checkFoodInCart(foodId); // Sử dụng repository
    ...
    public void release() {
        ...
        if (foodDetailModel != null) {
            foodDetailModel.release(); // Giải phóng repository
        }
    }
}
